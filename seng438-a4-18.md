...
In terms of DataUtilities, for the original test case, line coverage was 64% while mutation coverage was 52% as observed in the Pit Test Coverage Report. With the introduction of additional test cases, the line coverage was increased to 89% while mutation coverage was increased to 73%. This means the line coverage increased by 25% and the mutation coverage was increased by 21% (which exceeds the lab requirement of increasing the mutation score by at least 10%).

In terms of Range, for the original test case, line coverage was 54% while mutation coverage was 41% as shown in the Pit Test Coverage Report. With the introduction of additional test cases, the line coverage increased to 80% while the mutation coverage increased to 58%. This means the line coverage increased by 26% and the mutation coverage was increased by 17% (which exceeds the lab requirement of increasing the mutation score by at least 10%).
